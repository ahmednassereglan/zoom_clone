...
$("#btn__chat").click(function(){
        $(".main__right").toggleClass("main__right_dis", {duration:500});
        $(".main__left").toggleClass("main__left_flx", {duration:500});
    });
...
// $("#btn__chat").click(function(){
//     $(".main__right").addClass("main__right_dis");
//     $(".main__right").removeClass("dis_none");
//     $(".main__left").addClass("main__left_flx");
//     $(".main__left").removeClass("flx_dis");
// });
